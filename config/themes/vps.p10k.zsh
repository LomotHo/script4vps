# Generated by Powerlevel10k configuration wizard on 2020-03-27 at 03:00 EDT.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 36890.
# Wizard options: powerline, pure, rpromt, 1 line, compact, transient_prompt.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='ᐅ'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%F{$blue}# %F{$yellow}%m%f"
  # Context format when not root: user@host. The whole thing grey.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{$yellow}%n@%m%f"
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{$yellow}%m%f"
